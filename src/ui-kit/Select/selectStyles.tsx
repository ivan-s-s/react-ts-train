...
import { ETheme } from "ui-kit";
import { VARIANTS } from "./selectVariants";
import type { TSelectMultiType, TSelectOption } from "ui-kit";
  ...
  return {
    ...
    option: (provided, state) => ({
      ...
      backgroundColor: state.isSelected
        ? (style.option && style.option[":active"] && style.option[":active"].backgroundColor) || style.option.backgroundColor : (style.option && style.option.backgroundColor) || style.option.backgroundColor,
      borderRadius: style.option.borderRadius,
      color: state.isSelected
      ? (style.option && style.option[":active"] && style.option[":active"].color) || style.option.color : (style.option && style.option.color) || style.option.color,
